...
def blog(request):
    subscriber_form = SubscriberForm()
    return render(request, 'blog.html', {'subscriber_form': subscriber_form, 'blog_choices': BlogPosts.choices,
...
def training(request):
    return render(request, 'training_service.html')


def erp(request):
    return render(request, 'erp_service.html')


def digital(request):
    return render(request, 'digital_service.html')
...
def casestudy(request):
    ...
    return render(request, 'casestudy.html', {'subscriber_form': subscriber_form, 'choices': Portfolio.choices,
